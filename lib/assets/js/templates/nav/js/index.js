System.register('templates/nav/js/default.js', ['node_modules/systemjs-plugin-babel/babel-helpers/classCallCheck.js', 'node_modules/systemjs-plugin-babel/babel-helpers/createClass.js', 'common/scripts/modules/es6/analytics/events'], function (_export, _context) {
    "use strict";

    var _classCallCheck, _createClass, _analytics, Navigation;
    ...
    return {
        ...
        }, function (_commonScriptsModulesEs6AnalyticsEvents) {
            _analytics = _commonScriptsModulesEs6AnalyticsEvents.default;
        }],
        execute: function () {
            Navigation = function () {
                function Navigation() {
                ...
                _createClass(Navigation, [{
                    ...
                    value: function analytics() {
                        ...
                        _analytics.bind(document.querySelectorAll('.nav__wrapper .nav > li > a'), analyticActions);
                    }
                }]);
